package com.rslakra.microservice.commonservice;

import static com.rslakra.microservice.commonservice.CommonUtils.asIntegerPercentage;
import static com.rslakra.microservice.commonservice.CommonUtils.deserialize;
import static com.rslakra.microservice.commonservice.CommonUtils.validateSerialNumber;
import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.junit.jupiter.api.Assertions.assertThrows;
import static org.junit.jupiter.api.Assertions.assertTrue;

import com.rslakra.microservice.commonservice.exception.DeserializationException;
import com.rslakra.microservice.commonservice.exception.InvalidValueException;
...
public class CommonUtilsTest {
    ...
    private static final LocalDateTime TEST_START_DATE_TIME = LocalDateTime.of(2020, 10, 30, 12, 00);
    ...
    public void calculateVelocity_shouldReturnTheVelocityBetweenTwoPoints() throws InvalidValueException {
        ...
        double
            ...
            CommonUtils.calculateVelocity(TEST_START_LAT, TEST_START_LON, TEST_START_DATE_TIME, TEST_END_LAT,
                                          TEST_END_LON, TEST_END_DATE_TIME);
